          ...
          <div className="col-lg-8 col-md-8 padding-right-30">
            ...
            <div id="titlebar" className="listing-titlebar">
              <div className="listing-titlebar-title">
                <h2>
                  {chiTietPhong.name}
                  <span className="listing-tag">Apartments</span>
                </h2>
                <span>
                ...
                <div className="star-rating" data-rating={5}>
                  <div className="rating-counter">
                    <a href="#listing-reviews">{dsDanhGia?.length} reviews</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="listing-nav" className="listing-nav-container">
              <ul className="listing-nav">
                ...
                <li>
                  <a href="#listing-gallery">Gallery</a>
                </li>
                <li>
            ...
            <div id="listing-overview" className="listing-section">
              ...
              <div className="listing-links-container">
                <ul className="listing-links contact-links">
                  <li>
                    <a href="tel:12-345-678" className="listing-links">
                      <i className="fa fa-phone" /> +12 345 6578
                    </a>
                  </li>
                  <li>
                    <a href="mailto:mail@example.com" className="listing-links">
                      <i className="fa fa-envelope-o" /> mail@example.com
                    </a>
                  </li>
                  <li>
                    <a href="#" target="_blank" className="listing-links">
                      <i className="fa fa-link" /> www.example.com
                    </a>
                  </li>
                </ul>
                ...
                <ul className="listing-links">
                  <li>
                    <a href="#" target="_blank" className="listing-links-fb">
                      <i className="fa fa-facebook-square" /> Facebook
                    </a>
                  </li>
                  <li>
                    <a href="#" target="_blank" className="listing-links-yt">
                      <i className="fa fa-youtube-play" /> YouTube
                    </a>
                  </li>
                  <li>
                    <a href="#" target="_blank" className="listing-links-ig">
                      <i className="fa fa-instagram" /> Instagram
                    </a>
                  </li>
                  <li>
                    <a href="#" target="_blank" className="listing-links-tt">
            ...
            <div className="boxed-widget margin-top-35">
              <div className="hosted-by-title">
                ...
                <a href="pages-user-profile.html" className="hosted-by-avatar">
                  <img src="images/dashboard-avatar.jpg" />
                </a>
              </div>
