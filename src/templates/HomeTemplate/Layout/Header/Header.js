...
export default function Header() {
      ...
      return (
        <div className="dropdown">
          ...
          >
            ...
            <span className="text-dark px-2">{user.name}</span>
          </a>
  ...
  return (
    <Fragment>
        ...
        <div className="container">
          <nav className="navbar navbar-expand-lg ">
            <NavLink className="navbar-brand" to="/home">
              <span
                style={{ color: "#f91942", fontSize: 24, fontWeight: "700" }}
              >
                AIR
              </span>
              <span style={{ color: "black", fontSize: 20 }}>BnB</span>
            </NavLink>
            <button
      ...
      <Drawer title={id} placement="right" onClose={onClose} visible={visible}>
        <div>{Component}</div>
      </Drawer>
    </Fragment>
  );
